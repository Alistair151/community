...
//        session.setAttribute("kaptcha", text);
        ...
        // 验证码的归属者，随机生成一个字符串，作为临时的凭证, 放到cookie中作为每个用户的临时标识
        String verificationOwner = CommunityUtil.generateUUID();
        Cookie cookie = new Cookie("verificationOwner", verificationOwner);
        cookie.setMaxAge(60);
