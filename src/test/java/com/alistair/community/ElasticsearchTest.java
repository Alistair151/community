...
import com.alistair.community.dao.elastic.DiscussPostRepository;
...
public class ElasticsearchTest {
    ...
    public void testInsertList() {
        ...
        discussRepository.saveAll(discussMapper.selectDiscussPosts(166, 0, 100));
    ...
    void testUpdateDocument() throws IOException{
        UpdateRequest request = new UpdateRequest("discusspost", "247");
        request.timeout("1s");
        DiscussPost post = discussMapper.selectDiscussPostById(230);
        post.setContent("哈哈哈哈哈哈，笑死我了");
