...
public class RedisTest {
    ...
    // 多次访问同一个key
    @Test
    public void boundOperationTest() {
        String redisKey = "test:count";
    ...
    // 事务管理(编程式事务)
    // redis实现事务的机制是，将需要一起做的操作，放到集合中，统一做（而不是commit，rollback）
    // 所以不要把查询放在事务中，（因为没结果）
    @Test
    public void testTransactional() {
        Object obj = redisTemplate.execute(new SessionCallback() {
            ...
            public Object execute(RedisOperations operations) throws DataAccessException {
                ...
                operations.opsForSet().add(key, "alistair");
                operations.opsForSet().add(key, "liWeiJia");
                operations.opsForSet().add(key, "hanna");
